...
<div class="container" style="width: 80%; height: 50%">
    ...
    <a class="btn btn-success" href="<?=base_url('index.php/QuimicoColorC/insertQuimicoColor') ?>"><i class="fa-solid fa-plus"></i> Agregar Nuevo Químico</a> <br><br><br>
            ...
            <?php foreach ($quimicos as $key): ?> 
                <tr class="w-25 p-3">
                    <td align="center" class="w-auto p-3 align-middle"> <!-- <a class="btn btn-warning" href="<?=base_url('index.php/DepartamentosC/detalleDepartamento/').$key->id_Departamento ?>">Ver</a> -->
                     ...
                     <a class="btn btn-danger" href="<?=base_url('index.php/QuimicoColorC/borrarQuimicoColor/').$key->Nombre_Quimico ?>">Eliminar</a>
                </td>
